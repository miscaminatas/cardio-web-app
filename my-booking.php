...
<title>cardio | my bookings</title>
<!-- Style -->
...
<section class="pt-3 mt-3">
 <div class="container pt-5 mt-5">
	<div class="row">
	   ...
	   <div class="col">
		  <h3 class="py-3">My <strong>bookings</strong></h3>
<?php
$useremail=$_SESSION['login'];
$sql = "SELECT dbhall.image as image,dbhall.hallname,dbhall.id as hid,dbsport.sportname,dbbooking.fromdate,dbbooking.todate,dbbooking.message,dbbooking.status from dbbooking join dbhall on dbbooking.hallid=dbhall.id join dbsport on dbsport.id=dbhall.sport where dbbooking.userEmail=:useremail";
...
{  ?>
		  <ul class="list-unstyled">
			 <li class="media">
				<a href="hall-details.php?hid="<?php echo htmlentities($result->hid);?>"">
				<img class="mr-3" width="250" src="assets/img/<?php echo htmlentities($result->image);?>" alt="image"></a>
				<div>
				   <h6><a href="hall-details.php?hid="<?php echo htmlentities($result->hid);?>""> <?php echo htmlentities($result->hallname);?></a></h6>
